        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif font-bold text-duke-blue leading-[1.1] tracking-tight">
                aanya gupta
              </h1>

              <div className="space-y-5 text-lg sm:text-xl text-[#2a2a2a] leading-relaxed font-sans">
                <p>
                  i'm a student at{' '}
              ...
              <div className="pt-2 flex items-center gap-5">
                <a
                  ...
                  className="text-[#4a4a4a] hover:text-duke-blue transition-colors duration-200"
                  aria-label="GitHub"
                >
                  <svg
                    className="w-6 h-6"
                ...
                <a
                  href="mailto:aanyaashi@gmail.com"
                  className="text-[#4a4a4a] hover:text-duke-blue transition-colors duration-200"
                  aria-label="Email"
                >
                  <svg
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-serif font-bold text-duke-blue">projects</h2>
          ...
          <div className="lg:sticky lg:top-8 space-y-12">
            {/* Interests */}
            <div className="space-y-4">
              <h2 className="text-xl font-serif font-bold text-duke-blue">interests</h2>
